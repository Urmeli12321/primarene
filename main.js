    ...
    if (!message.author.bot) {
       ...
       if(message.content == `${BotSettings.prefix}botinfo`){
           var embed = new Discord.RichEmbed()
                ...
                .addField(`Willst du mich adden?`,`[Dann klick hier](https://discordapp.com/oauth2/authorize?client_id=547147930235043888&permissions=12345678&scope=bothttps://discordapp.com/api/oauth2/authorize?client_id=525663532398673950&permissions=12345678&scope=botv)`)
