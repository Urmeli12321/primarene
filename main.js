...
const BotSettings = require("./botsettings.json")
    ...
    bot.user.setActivity(`${BotSettings.prefix}Schaut alexi 24/7 unter den Rock 😍`, {
    ...
    if (!message.author.bot) {
       ...
       if(message.content == `${BotSettings.prefix}botinfo`){
           var embed = new Discord.RichEmbed()
                ...
                .addField(`Willst du mich adden?`,`[Dann klick hier](https://discordapp.com/api/oauth2/authorize?client_id=525663532398673950&permissions=8&scope=bot) **du waschlappen**`)
